...
if __name__ == "__main__":  
    ...
    pygame.display.set_caption("tree shape test")
    screen = pygame.display.set_mode((640, 320))
    screen.fill((255, 255, 255))
    treelayer = pygame.Surface((640, 320))
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                screen.fill((255, 255, 255))
                treelayer.fill((255, 255, 255))
                random.choice([tree1, tree2, tree3, tree4])(treelayer, 200, 320, 10)
                # tree2(treelayer, 200, 320, 10)
                screen.blit(treelayer, (0, 0))
                pygame.display.flip()